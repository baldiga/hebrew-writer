...
name: hebrew-writer
description: |
  v2 — Write Hebrew content indistinguishable from a native Israeli human.
  Generates, rewrites, or detects AI patterns in Hebrew text.
  8-layer system: Hebrew-first thinking, 55+ AI pattern detection,
  Israeli voice injection, linguistic precision, rhythm engineering,
  self-audit scoring (95/100 threshold), voice cloning, and the new
  Soul Layer (נשמה עמוקה) — 20 concrete techniques for specificity,
  conviction, vulnerability, non-linearity, and Hebrew soul markers.
  Data-grounded in 90M+ words of Israeli podcast transcripts (ivrit.ai)
  and 40+ academic sources including Princeton 2025 study.
...
### 5b. נשמה עמוקה — Deep Soul (weight: 8%)
